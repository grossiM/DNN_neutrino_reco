...
hdf_signal = pd.read_hdf('/afs/f9.ijs.si/home/jakobn/DNN-plots/HHbbWW_official/signal_ntuples_eval.calibrated.h5')
hdf_signal_reco = pd.read_hdf('/afs/f9.ijs.si/home/jakobn/DNN-plots/HHbbWW_1lep/signal_1lep_eval.calibrated.h5')
hdf_ttbar = pd.read_hdf('/afs/f9.ijs.si/home/jakobn/DNN-plots/HHbbWW_1lep/ttbar.calibrated.h5')

higgs_mass_truenu = hdf_signal.eval('sqrt((HadWE + LepE + sqrt((TrueNuPz)**2 + MET_px**2 + MET_py**2))**2 - (HadWPx + LepPx + MET_px)**2 - (HadWPy + LepPy + MET_py)**2 - (HadWPz + LepPz + TrueNuPz)**2)')
higgs_mass_truew = hdf_signal.eval('sqrt((HadWE + LepE + sqrt((hid4neu60_pred)**2 + MET_px**2 + MET_py**2))**2 - (HadWPx + LepPx + MET_px)**2 - (HadWPy + LepPy + MET_py)**2 - (HadWPz + LepPz + hid4neu60_pred)**2)')
higgs_mass_reco = hdf_signal_reco.eval('sqrt((Jet1E + Jet2E + LepE + sqrt((hid4neu60_pred)**2 + MET_px**2 + MET_py**2))**2 - (Jet1Px + Jet2Px + LepPx + MET_px)**2 - (Jet1Py + Jet2Py + LepPy + MET_py)**2 - (Jet1Pz + Jet2Pz + LepPz + hid4neu60_pred)**2)')
...
# higgs_mass_signal = hdf_signal.eval('sqrt((Jet1E + Jet2E + LepE + sqrt((TrueNuPz)**2 + MET_px**2 + MET_py**2))**2 - (Jet1Px + Jet2Px + LepPx + MET_px)**2 - (Jet1Py + Jet2Py + LepPy + MET_py)**2 - (Jet1Pz + Jet2Pz + LepPz + TrueNuPz)**2)')
# higgs_mass_signal = hdf_signal.eval('sqrt((HadWE + LepE + sqrt((TrueNuPz)**2 + MET_px**2 + MET_py**2))**2 - (HadWPx + LepPx + MET_px)**2 - (HadWPy + LepPy + MET_py)**2 - (HadWPz + LepPz + TrueNuPz)**2)')
# higgs_mass_ttbar = hdf_ttbar.eval('sqrt((Jet1E + Jet2E + LepE + sqrt((hid4neu60_pred)**2 + MET_px**2 + MET_py**2))**2 - (Jet1Px + Jet2Px + LepPx + MET_px)**2 - (Jet1Py + Jet2Py + LepPy + MET_py)**2 - (Jet1Pz + Jet2Pz + LepPz + hid4neu60_pred)**2)')
# w_mass_signal = hdf_signal.eval('sqrt((LepE + sqrt((hid4neu60_pred)**2 + MET_px**2 + MET_py**2))**2 - (LepPx + MET_px)**2 - (LepPy + MET_py)**2 - (LepPz + hid4neu60_pred)**2)')
...
# w_mass_signal = hdf_signal.eval('sqrt((LepE + sqrt((TrueNuPz)**2 + MET_px**2 + MET_py**2))**2 - (LepPx + MET_px)**2 - (LepPy + MET_py)**2 - (LepPz + TrueNuPz)**2)')
# w_mass_ttbar = hdf_ttbar.eval('sqrt((LepE + sqrt((TrueNuPz)**2 + MET_px**2 + MET_py**2))**2 - (LepPx + MET_px)**2 - (LepPy + MET_py)**2 - (LepPz + TrueNuPz)**2)')

w_mass_truenu = hdf_signal.eval('sqrt((LepE + sqrt((TrueNuPz)**2 + MET_px**2 + MET_py**2))**2 - (LepPx + MET_px)**2 - (LepPy + MET_py)**2 - (LepPz + TrueNuPz)**2)')
w_mass_reco = hdf_signal_reco.eval('sqrt((LepE + sqrt(hid4neu60_pred**2 + MET_px**2 + MET_py**2))**2 - (LepPx + MET_px)**2 - (LepPy + MET_py)**2 - (LepPz + hid4neu60_pred)**2)')
w_mass_ttbar = hdf_ttbar.eval('sqrt((LepE + sqrt(hid4neu60_pred**2 + MET_px**2 + MET_py**2))**2 - (LepPx + MET_px)**2 - (LepPy + MET_py)**2 - (LepPz + hid4neu60_pred)**2)')
...
plt.title('Non-resonant 1 lepton')
...
'''
abs_signal = hdf_signal.eval('MET_px - TrueNuPx')
abs_ttbar = hdf_ttbar.eval('MET_px - TrueNuPx')
rel_signal = hdf_signal.eval('MET_py - TrueNuPy')
rel_ttbar = hdf_ttbar.eval('MET_py - TrueNuPy')
