...
#inverto criteri selezione e conto i random
...
def tag_selectioncriteria_iteration( a, b, pLplus, pLminus, v_pz, v_mu_sol0, v_mu_sol1):
    ...
    return sel1,sel2,sel3,sel4,sel5,counter_1,counter_2,counter_3,counter_4,counter_5
#1
def tag_selectioncriteria( pdarray, flavour):
    ...
    sel1,sel2,sel3,sel4,sel5,counter_1,counter_2,counter_3,counter_4,counter_5 = tag_selectioncriteria_vectorized( a, b, pLplus, pLminus, v_pz, v_mu_sol0, v_mu_sol1)
